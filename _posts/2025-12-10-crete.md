...
title: "Crete"
categories: misc
image: /assets/crete/IMG_3219.webp
---
...
<img src="{{ '/assets/crete/IMG_2712.webp' | relative_url }}" alt="Crete's coastline seen from the plane" style="width:100%; border-radius:4px;">
...
<img src="{{ '/assets/crete/IMG_3087.webp' | relative_url }}" alt="A local resident" style="width:100%; border-radius:4px;">
...
<img src="{{ '/assets/crete/IMG_2834.webp' | relative_url }}" alt="The reconstructed palace of Knossos" style="width:100%; border-radius:4px;">
...
<img src="{{ '/assets/crete/IMG_1991.webp' | relative_url }}" alt="Chickpea stew and vegetables" style="width:100%; height:160px; object-fit:cover; border-radius:4px;">
<figcaption>Chickpea stew</figcaption>
</figure>
<figure style="flex:1 1 140px; max-width:200px; text-align:center;">
<img src="{{ '/assets/crete/IMG_2410.webp' | relative_url }}" alt="Dolmades - stuffed vine leaves" style="width:100%; height:160px; object-fit:cover; border-radius:4px;">
<figcaption>Dolmades</figcaption>
</figure>
<figure style="flex:1 1 140px; max-width:200px; text-align:center;">
<img src="{{ '/assets/crete/IMG_2752.webp' | relative_url }}" alt="A Cretan taverna spread" style="width:100%; height:160px; object-fit:cover; border-radius:4px;">
<figcaption>Taverna spread</figcaption>
</figure>
<figure style="flex:1 1 140px; max-width:200px; text-align:center;">
<img src="{{ '/assets/crete/IMG_3060.webp' | relative_url }}" alt="Olive oil tasting at a farm near Archanes" style="width:100%; height:160px; object-fit:cover; border-radius:4px;">
...
<img src="{{ '/assets/crete/IMG_3219.webp' | relative_url }}" alt="The Venetian harbor of Chania" style="width:100%; border-radius:4px;">
...
<img src="{{ '/assets/crete/IMG_1999.webp' | relative_url }}" alt="Heraklion's old harbor at night"
...
<img src="{{ '/assets/crete/IMG_2171.webp' | relative_url }}" alt="Heraklion's old harbor at night"
...
<img src="{{ '/assets/crete/IMG_3216.webp' | relative_url }}" alt="Ancient ruins visible beneath a glass floor in a Chania souvenir shop" style="width:100%; border-radius:4px;">
...
<img src="{{ '/assets/crete/IMG_3301.webp' | relative_url }}" alt="Saint Minas Cathedral in Heraklion" style="width:100%; border-radius:4px;">
<figcaption>Saint Minas Cathedral, Heraklion</figcaption>
</figure>
<figure style="flex:1; max-width:220px; text-align:center;">
<img src="{{ '/assets/crete/IMG_2048.webp' | relative_url }}" alt="A stone archway in the old town" style="width:100%; border-radius:4px;">
<figcaption>A Venetian archway in the old town of Rethymno</figcaption>
</figure>
<figure style="flex:1; max-width:220px; text-align:center;">
<img src="{{ '/assets/crete/IMG_2431.webp' | relative_url }}" alt="Baroque detail inside a Cretan church" style="width:100%; border-radius:4px;">
<figcaption>Venetian loggia in Heraklion</figcaption>
</figure>
<figure style="flex:1; max-width:220px; text-align:center;">
<img src="{{ '/assets/crete/IMG_2125.webp' | relative_url }}" alt="A street in Rethymno's old quarter" style="width:100%; border-radius:4px;">
...
<img src="{{ '/assets/crete/IMG_2743.webp' | relative_url }}" alt="Lake Voulismeni in Agios Nikolaos" style="width:100%; border-radius:4px;">
<figcaption>Lake Voulismeni connecting to the sea, Agios Nikolaos</figcaption>
</figure>
<figure style="flex:1; max-width:46%; text-align:center;">
<img src="{{ '/assets/crete/IMG_2154.webp' | relative_url }}" alt="The Fortezza walls at sunset overlooking the sea" style="width:100%; border-radius:4px;">
<figcaption>The Fortezza walls at sunset</figcaption>
</figure>
<figure style="flex:1; max-width:46%; text-align:center;">
<img src="{{ '/assets/crete/IMG_3129.webp' | relative_url }}" alt="A hilltop chapel near Anogia with a panoramic view of the island" style="width:100%; border-radius:4px;">
